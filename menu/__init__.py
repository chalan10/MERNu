...
app.config.from_object('menu.config')
...
app.config.from_envvar('MENU_SETTINGS', silent=True)
...
import menu.api  # noqa: E402  pylint: disable=wrong-import-position
import menu.views  # noqa: E402  pylint: disable=wrong-import-position
import menu.model  # noqa: E402  pylint: disable=wrong-import-position
